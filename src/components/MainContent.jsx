  ...
  return (
    <>
      <div className="flex-1 px-8 bg-slate-100 dark:bg-slate-900">
        <div className="flex flex-col py-16 justify-center h-full rounded-lg dark:bg-slate-700 p-6">
          <div className="pl-10">
          ...
          <div className="self-center mt-auto">
            <button className="inline-flex items-center justify-center px-10 py-4 bg-green-600 hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-green-500 focus:ring-opacity-50 text-white text-sm font-semibold rounded-full shadow-lg transition-all duration-300 ease-in-out group">
              Learn More
