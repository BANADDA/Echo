...
export function Footer() {
          ...
          <div className="grid grid-cols-3 justify-between gap-4">
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <Typography
                  color="blue-gray"
                  className="mb-3 font-medium opacity-40 text-2xl text-white"
                >
                  {title}
                </Typography>
                {items.map((link) => (
  ...
  text-gray-400  hover:text-white                       color="gray"
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          <div className="flex gap-4 sm:justify-center">
            <Typography as="a" className="opacity-80  text-gray-400  hover:text-white  transition-opacity hover:opacity-100">
