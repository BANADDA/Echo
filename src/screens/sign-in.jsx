...
export function SignIn() {
  ...
  const handleEmailPasswordSignIn = async (event) => {
    ...
    return (
    <section className="row-auto m-8 flex gap-4 min-h-screen justify-center">
      <div className="w-1/3 lg:w-3/5 mt-24">
            {signInError && <Alert color="red">{signInError}</Alert>}
          <div className="text-center">
            <Typography variant="h1" className="text-5xl font-bold mb-4">Echo</Typography>
            <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal">Enter your email and password to Sign In.</Typography>
            <hr></hr>
          </div>
        <form onSubmit={handleEmailPasswordSignIn} className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <Checkbox
            label={
              <Typography variant="small" color="gray" className="flex items-center justify-start font-medium">
                I agree to the&nbsp;<a href="#" className="font-normal text-black transition-colors hover:text-gray-900 underline">Terms and Conditions</a>
              </Typography>
            }
